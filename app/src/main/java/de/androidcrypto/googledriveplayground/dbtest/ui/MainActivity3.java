...
package de.androidcrypto.googledriveplayground.dbtest.ui;

import static de.androidcrypto.googledriveplayground.dbtest.db.DBHelper.getDatabaseVersion;
...
import de.androidcrypto.googledriveplayground.dbtest.backup.LocalBackup;
import de.androidcrypto.googledriveplayground.dbtest.backup.RemoteBackup;
import de.androidcrypto.googledriveplayground.dbtest.data.Exam;
import de.androidcrypto.googledriveplayground.dbtest.data.Student;
import de.androidcrypto.googledriveplayground.dbtest.db.DBHelper;

/**
 * subproject seems to use deprecated Google Drive API
 */
    ...
    private void showMultichoice() {
        ...
        builderChoose
                .setItems(items, (dialog, which) -> {
                    switch (which) {
                        case 0:
                            Intent addStud = new Intent(MainActivity3.this, AddStudent.class);
                            startActivity(addStud);
                            break;

                        case 1:
                            Intent addExam = new Intent(MainActivity3.this, AddExam.class);
