package de.androidcrypto.googledriveplayground.ammarptn;
 ...
 */
@Deprecated
public class AppDataDriveServiceHelper4 {
    ...
    public AppDataDriveServiceHelper4(Drive driveService) {
    ...
    public Task<GoogleDriveFileHolder4> createTextFile(final String fileName, final String content, @Nullable final String folderId) {
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder4>() {
            @Override
            public GoogleDriveFileHolder4 call() throws Exception {
                ...
                GoogleDriveFileHolder4 googleDriveFileHolder = new GoogleDriveFileHolder4();
    ...
    public Task<GoogleDriveFileHolder4> createTextFileIfNotExist(final String fileName, final String content, @Nullable final String folderId) {
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder4>() {
            @Override
            public GoogleDriveFileHolder4 call() throws Exception {
                GoogleDriveFileHolder4 googleDriveFileHolder = new GoogleDriveFileHolder4();
    ...
    public Task<GoogleDriveFileHolder4> createFolder(final String folderName, @Nullable final String folderId) {
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder4>() {
            @Override
            public GoogleDriveFileHolder4 call() throws Exception {
                GoogleDriveFileHolder4 googleDriveFileHolder = new GoogleDriveFileHolder4();
    ...
    public Task<GoogleDriveFileHolder4> createFolder(final String folderName, @Nullable final String folderId) {
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder4>() {
            @Override
            public GoogleDriveFileHolder4call() throws Exception {
                GoogleDriveFileHolder4 googleDriveFileHolder = new GoogleDriveFileHolder4();
    ...
    public Task<GoogleDriveFileHolder4> createFolderIfNotExist(final String folderName, @Nullable final String parentFolderId) {
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder4>() {
            @Override
            public GoogleDriveFileHolder4 call() throws Exception {
                GoogleDriveFileHolder4 googleDriveFileHolder = new GoogleDriveFileHolder4();
...
//                googleDriveFileHolder.setSize(result.getFiles().get(0).getSize());
    ...
    public Task<GoogleDriveFileHolder4> uploadFile(final File googleDiveFile, final AbstractInputStreamContent content) {
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder4>() {
            @Override
            public GoogleDriveFileHolder4 call() throws Exception {
                // Retrieve the metadata as a File object.
    ...
    public Task<GoogleDriveFileHolder4> uploadFile(final java.io.File localFile, final String mimeType, @Nullable final String folderId) {
        return Tasks.call(mExecutor, new Callable<GoogleDriveFileHolder4>() {
            @Override
            public GoogleDriveFileHolder4 call() throws Exception {
                // Retrieve the metadata as a File object.
    ...
    public Task<List<GoogleDriveFileHolder4>> searchFolder(final String folderName) {
        return Tasks.call(mExecutor, new Callable<List<GoogleDriveFileHolder4>>() {
            @Override
            public List<GoogleDriveFileHolder4> call() throws Exception {
                List<GoogleDriveFileHolder4> googleDriveFileHolderList = new ArrayList<>();
    ...
    public Task<List<GoogleDriveFileHolder4>> searchFile(final String fileName, final String mimeType) {
        return Tasks.call(mExecutor, new Callable<List<GoogleDriveFileHolder4>>() {
            @Override
            public List<GoogleDriveFileHolder4> call() throws Exception {
                List<GoogleDriveFileHolder4> googleDriveFileHolderList = new ArrayList<>();
     ...
     */
    public Task<List<GoogleDriveFileHolder4>> queryFiles() {
        return Tasks.call(mExecutor, new Callable<List<GoogleDriveFileHolder4>>() {
                    @Override
                    public List<GoogleDriveFileHolder4> call() throws Exception {
                        List<GoogleDriveFileHolder4> googleDriveFileHolderList = new ArrayList<>();
    ...
    public Task<List<GoogleDriveFileHolder4>> queryFiles(@Nullable final String folderId) {
        return Tasks.call(mExecutor, new Callable<List<GoogleDriveFileHolder4>>() {
                    @Override
                    public List<GoogleDriveFileHolder4> call() throws Exception {
                        List<GoogleDriveFileHolder4> googleDriveFileHolderList = new ArrayList<>();
