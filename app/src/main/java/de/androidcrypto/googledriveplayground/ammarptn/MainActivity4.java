...
import static de.androidcrypto.googledriveplayground.ammarptn.DriveServiceHelper4.getGoogleDriveService;
...
public class MainActivity4 extends AppCompatActivity {
    ...
    private DriveServiceHelper4 mDriveServiceHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDriveServiceHelper.searchFile("textfilename.txt", "text/plain")
                        .addOnSuccessListener(new OnSuccessListener<List<GoogleDriveFileHolder4>>() {
                            @Override
                            public void onSuccess(List<GoogleDriveFileHolder4> googleDriveFileHolders) {
        ...
        createTextFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDriveServiceHelper.createTextFile("textfilename.txt", "some text", null)
                        .addOnSuccessListener(new OnSuccessListener<GoogleDriveFileHolder4>() {
                            @Override
                            public void onSuccess(GoogleDriveFileHolder4 googleDriveFileHolder) {
                                Gson gson = new Gson();
        ...
        viewFileFolder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println("*** call GDriveDebugViewActivity");
    ...
    protected void onStart() {
        ...
        if (account == null) {
            ...
            mDriveServiceHelper = new DriveServiceHelper4(getGoogleDriveService(getApplicationContext(), account, "appName"));
        }
    }
        ...
        GoogleSignIn.getSignedInAccountFromIntent(result)
                .addOnSuccessListener(new OnSuccessListener<GoogleSignInAccount>() {
                    ...
                    public void onSuccess(GoogleSignInAccount googleSignInAccount) {
                        ...
                        mDriveServiceHelper = new DriveServiceHelper4(getGoogleDriveService(getApplicationContext(), googleSignInAccount, "appName"));
